...
{
    public class PutSuperpoderInputModel
    {
        /// <summary>
    ...
    public class PutSuperpoderInputModelValidator : AbstractValidator<PutSuperpoderInputModel>
    {
        public PutSuperpoderInputModelValidator()
        {
